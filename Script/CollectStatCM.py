...
def CollectFTError(answer_file_prefix):
    res_path = answer_file_prefix + 'CM/' + query_name + '/'
    ...
    stat_file = open('../Stat/' + dataset + '_' + query_name + '_CM_stat.txt', 'w')
    writeline = 'dataset=%s, query_name=%s (CM)'%(dataset, query_name)
...
def main(argv):
    ...
    CollectFTError(answer_file_prefix)
