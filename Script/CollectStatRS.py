...
def CollectRSError(answer_file_prefix):
    res_path = answer_file_prefix + 'RS/' + query_name + '/'
    ...
    stat_file = open('../Stat/' + dataset + '_' + query_name + '_RS_stat.txt', 'w')
    writeline = 'dataset=%s, query_name=%s (RS)'%(dataset, query_name)
...
def main(argv):
    ...
    CollectRSError(answer_file_prefix)
